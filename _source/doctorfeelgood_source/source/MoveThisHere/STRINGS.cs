        ...
        public class BUILDINGS
        {
            ...
            public class BUTTONS
            {
                public class HAULINGPOINT
                {
                    ...
                    // Allow Item Removal
                    public static LocString ALLOW_ITEM_REMOVAL_ON = "Allow Item Removal";
                    public static LocString ALLOW_ITEM_REMOVAL_ON_TOOLTIP = "If enabled, Duplicants can retrieve items from this hauling point for building or other tasks";
                    public static LocString ALLOW_ITEM_REMOVAL_OFF = "Disallow Item Removal";
                    public static LocString ALLOW_ITEM_REMOVAL_OFF_TOOLTIP = "If disabled, items stored here will be locked inside until dropped or empty";
