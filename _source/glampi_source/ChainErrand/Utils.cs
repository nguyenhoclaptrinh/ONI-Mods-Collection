...
namespace ChainErrand {
   public static class Utils {
      ...
      public static HashSet<GameObject> CollectPrioritizableObjects(Extents extents) {
         ...
         var entries = new System.Collections.Generic.List<ScenePartitionerEntry>();
         GameScenePartitioner.Instance.GatherEntries(extents.x, extents.y, extents.width, extents.height, GameScenePartitioner.Instance.prioritizableObjects, entries);
         foreach (var gatheredObject in entries) {
            GameObject obj = (gatheredObject.obj as Component)?.gameObject;
