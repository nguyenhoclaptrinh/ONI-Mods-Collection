...
namespace ChooseNeuralVacillator
{
    ...
    public class ApplyRandomTraitPatch
    {
		...
		/// </summary>
		private static void TraitSelected(WorkerBase worker, bool ___IsConsumed, GeneShuffler.GeneShufflerSM.Instance ___geneShufflerSMI, string traitID)
        {
			string id = traitID;
		...
		/// </summary>
		private static void RandomSelected(WorkerBase worker, bool ___IsConsumed, GeneShuffler.GeneShufflerSM.Instance ___geneShufflerSMI, List<string> list)
        {
