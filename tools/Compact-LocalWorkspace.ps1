...
$MaintainedSourcePaths = @(
    ...
    "_source/AzeTheGreat_source/src/SuppressNotifications",
    "_source/AzeTheGreat_source/src/AzeLib",
    "_source/AzeTheGreat_source/Translations",
    "_source/peterhan_source/AIImprovements",
    "_source/peterhan_source/PLibCore",
    "_source/peterhan_source/PLibActions",
    "_source/peterhan_source/PLibAVC",
    "_source/peterhan_source/PLibBuildings",
    "_source/peterhan_source/PLibDatabase",
    "_source/peterhan_source/PLibLighting",
    "_source/peterhan_source/PLibOptions",
    "_source/peterhan_source/PLibUI",
    "_source/glampi_source/AutoDropBottlers",
    "_source/doctorfeelgood_source/source/MoveThisHere",
    "_source/beatlepie_source/ChooseNeuralVacillator",
    "_source/customizable_speed_source",
    "_source/CritterAIArchitect",
    "_source/MoveThisHere"
)
