...
{
	internal class DerelictBackwallConfig : IBuildingConfig
	{
		public static string ID = "RTB_DerelictExteriorWall";
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 1, 1, "gravitas_walls_kanim", 30, 3f, tieR2, rawMineralsOrWood, 1600f, BuildLocationRule.NotInTiles, decor, noise);
